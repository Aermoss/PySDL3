...
import sys, os, requests, ctypes, ctypes.util, platform, keyword, collections.abc as abc, re, \
    asyncio, aiohttp, zipfile, typing, types, array, inspect, atexit, packaging.version, json
