...
SDL_FUNC("SDL_SetThreadPriority", ctypes.c_int, SDL_ThreadPriority)
...
SDL_FUNC("SDL_SetTLS", ctypes.c_int, ctypes.POINTER(SDL_TLSID), ctypes.c_void_p, SDL_TLSDestructorCallback)
