...
SDL_SystemCursor: typing.TypeAlias = SDL_TYPE["SDL_SystemCursor", ctypes.c_int]
...
SDL_MouseWheelDirection: typing.TypeAlias = SDL_TYPE["SDL_MouseWheelDirection", ctypes.c_int]
