...
SDL_FUNC("SDL_UpdateHapticEffect", ctypes.c_int, ctypes.POINTER(SDL_Haptic), ctypes.c_int, ctypes.POINTER(SDL_HapticEffect))
SDL_FUNC("SDL_RunHapticEffect", ctypes.c_int, ctypes.POINTER(SDL_Haptic), ctypes.c_int, ctypes.c_uint32)
SDL_FUNC("SDL_StopHapticEffect", ctypes.c_int, ctypes.POINTER(SDL_Haptic), ctypes.c_int)
SDL_FUNC("SDL_DestroyHapticEffect", None, ctypes.POINTER(SDL_Haptic), ctypes.c_int)
SDL_FUNC("SDL_GetHapticEffectStatus", ctypes.c_int, ctypes.POINTER(SDL_Haptic), ctypes.c_int)
SDL_FUNC("SDL_SetHapticGain", ctypes.c_int, ctypes.POINTER(SDL_Haptic), ctypes.c_int)
SDL_FUNC("SDL_SetHapticAutocenter", ctypes.c_int, ctypes.POINTER(SDL_Haptic), ctypes.c_int)
SDL_FUNC("SDL_PauseHaptic", ctypes.c_int, ctypes.POINTER(SDL_Haptic))
SDL_FUNC("SDL_ResumeHaptic", ctypes.c_int, ctypes.POINTER(SDL_Haptic))
SDL_FUNC("SDL_StopHapticEffects", ctypes.c_int, ctypes.POINTER(SDL_Haptic))
SDL_FUNC("SDL_HapticRumbleSupported", ctypes.c_bool, ctypes.POINTER(SDL_Haptic))
SDL_FUNC("SDL_InitHapticRumble", ctypes.c_int, ctypes.POINTER(SDL_Haptic))
SDL_FUNC("SDL_PlayHapticRumble", ctypes.c_int, ctypes.POINTER(SDL_Haptic), ctypes.c_float, ctypes.c_uint32)
SDL_FUNC("SDL_StopHapticRumble", ctypes.c_int, ctypes.POINTER(SDL_Haptic))