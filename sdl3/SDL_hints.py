...
SDL_HINT_ANDROID_AAUDIO_INPUT_PRESET: bytes = "SDL_ANDROID_AAUDIO_INPUT_PRESET".encode()
...
SDL_HINT_AUDIO_DEVICE_RAW_STREAM: bytes = "SDL_AUDIO_DEVICE_RAW_STREAM".encode()
...
SDL_HINT_INVALID_PARAM_CHECKS: bytes = "SDL_INVALID_PARAM_CHECKS".encode()
...
SDL_HINT_ENABLE_STEAM_SCREEN_KEYBOARD: bytes = "SDL_ENABLE_STEAM_SCREEN_KEYBOARD".encode()
...
SDL_HINT_HIDAPI_LIBUSB_GAMECUBE: bytes = "SDL_HIDAPI_LIBUSB_GAMECUBE".encode()
...
SDL_HINT_JOYSTICK_GAMEINPUT_RAW: bytes = "SDL_JOYSTICK_GAMEINPUT_RAW".encode()
...
SDL_HINT_JOYSTICK_HIDAPI_LG4FF: bytes = "SDL_JOYSTICK_HIDAPI_LG4FF".encode()
SDL_HINT_JOYSTICK_HIDAPI_8BITDO: bytes = "SDL_JOYSTICK_HIDAPI_8BITDO".encode()
SDL_HINT_JOYSTICK_HIDAPI_SINPUT: bytes = "SDL_JOYSTICK_HIDAPI_SINPUT".encode()
SDL_HINT_JOYSTICK_HIDAPI_ZUIKI: bytes = "SDL_JOYSTICK_HIDAPI_ZUIKI".encode()
SDL_HINT_JOYSTICK_HIDAPI_FLYDIGI: bytes = "SDL_JOYSTICK_HIDAPI_FLYDIGI".encode()
...
SDL_HINT_JOYSTICK_HIDAPI_SWITCH2: bytes = "SDL_JOYSTICK_HIDAPI_SWITCH2".encode()
...
SDL_HINT_JOYSTICK_HIDAPI_GIP: bytes = "SDL_JOYSTICK_HIDAPI_GIP".encode()
SDL_HINT_JOYSTICK_HIDAPI_GIP_RESET_FOR_METADATA: bytes = "SDL_JOYSTICK_HIDAPI_GIP_RESET_FOR_METADATA".encode()
...
SDL_HINT_KMSDRM_ATOMIC: bytes = "SDL_KMSDRM_ATOMIC".encode()
...
SDL_HINT_MAC_PRESS_AND_HOLD: bytes = "SDL_MAC_PRESS_AND_HOLD".encode()
...
SDL_HINT_MOUSE_DPI_SCALE_CURSORS: bytes = "SDL_MOUSE_DPI_SCALE_CURSORS".encode()
...
SDL_HINT_OPENGL_FORCE_SRGB_FRAMEBUFFER: bytes = "SDL_OPENGL_FORCE_SRGB_FRAMEBUFFER".encode()
...
SDL_HINT_RENDER_DIRECT3D11_WARP: bytes = "SDL_RENDER_DIRECT3D11_WARP".encode()
...
SDL_HINT_PS2_GS_WIDTH: bytes = "SDL_PS2_GS_WIDTH".encode()
SDL_HINT_PS2_GS_HEIGHT: bytes = "SDL_PS2_GS_HEIGHT".encode()
SDL_HINT_PS2_GS_PROGRESSIVE: bytes = "SDL_PS2_GS_PROGRESSIVE".encode()
SDL_HINT_PS2_GS_MODE: bytes = "SDL_PS2_GS_MODE".encode()
...
SDL_HINT_VIDEO_METAL_AUTO_RESIZE_DRAWABLE: bytes = "SDL_VIDEO_METAL_AUTO_RESIZE_DRAWABLE".encode()
SDL_HINT_VIDEO_MATCH_EXCLUSIVE_MODE_ON_MOVE: bytes = "SDL_VIDEO_MATCH_EXCLUSIVE_MODE_ON_MOVE".encode()
...
SDL_HINT_VIDEO_X11_ENABLE_XSYNC_EXT: bytes = "SDL_VIDEO_X11_ENABLE_XSYNC_EXT".encode()
...
SDL_HINT_WINDOWS_RAW_KEYBOARD_EXCLUDE_HOTKEYS: bytes = "SDL_WINDOWS_RAW_KEYBOARD_EXCLUDE_HOTKEYS".encode()
SDL_HINT_WINDOWS_RAW_KEYBOARD_INPUTSINK: bytes = "SDL_WINDOWS_RAW_KEYBOARD_INPUTSINK".encode()
