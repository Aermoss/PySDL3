...
SDL_FUNC("SDL_GetKeyboards", SDL_POINTER[SDL_KeyboardID], SDL_POINTER[ctypes.c_int])
SDL_FUNC("SDL_GetKeyboardNameForID", ctypes.c_char_p, SDL_KeyboardID)
SDL_FUNC("SDL_GetKeyboardFocus", SDL_POINTER[SDL_Window])
SDL_FUNC("SDL_GetKeyboardState", SDL_POINTER[ctypes.c_bool], SDL_POINTER[ctypes.c_int])
...
SDL_FUNC("SDL_GetScancodeFromKey", SDL_Scancode, SDL_Keycode, SDL_POINTER[SDL_Keymod])
...
SDL_FUNC("SDL_StartTextInput", ctypes.c_bool, SDL_POINTER[SDL_Window])
...
SDL_FUNC("SDL_StartTextInputWithProperties", ctypes.c_bool, SDL_POINTER[SDL_Window], SDL_PropertiesID)
...
SDL_FUNC("SDL_TextInputActive", ctypes.c_bool, SDL_POINTER[SDL_Window])
SDL_FUNC("SDL_StopTextInput", ctypes.c_bool, SDL_POINTER[SDL_Window])
SDL_FUNC("SDL_ClearComposition", ctypes.c_bool, SDL_POINTER[SDL_Window])
SDL_FUNC("SDL_SetTextInputArea", ctypes.c_bool, SDL_POINTER[SDL_Window], SDL_POINTER[SDL_Rect], ctypes.c_int)
SDL_FUNC("SDL_GetTextInputArea", ctypes.c_bool, SDL_POINTER[SDL_Window], SDL_POINTER[SDL_Rect], SDL_POINTER[ctypes.c_int])
SDL_FUNC("SDL_HasScreenKeyboardSupport", ctypes.c_bool)
SDL_FUNC("SDL_ScreenKeyboardShown", ctypes.c_bool, SDL_POINTER[SDL_Window])