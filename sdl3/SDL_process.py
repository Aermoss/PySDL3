...
SDL_FUNC("SDL_CreateProcess", SDL_POINTER[SDL_Process], SDL_POINTER[ctypes.c_char_p], ctypes.c_bool)
...
SDL_FUNC("SDL_CreateProcessWithProperties", SDL_POINTER[SDL_Process], SDL_PropertiesID)
...
SDL_FUNC("SDL_GetProcessProperties", SDL_PropertiesID, SDL_POINTER[SDL_Process])
...
SDL_FUNC("SDL_ReadProcess", ctypes.c_void_p, SDL_POINTER[SDL_Process], SDL_POINTER[ctypes.c_size_t], SDL_POINTER[ctypes.c_int])

SDL_FUNC("SDL_GetProcessInput", SDL_POINTER[SDL_IOStream], SDL_POINTER[SDL_Process])
SDL_FUNC("SDL_GetProcessOutput", SDL_POINTER[SDL_IOStream], SDL_POINTER[SDL_Process])

SDL_FUNC("SDL_KillProcess", ctypes.c_bool, SDL_POINTER[SDL_Process], ctypes.c_bool)
SDL_FUNC("SDL_WaitProcess", ctypes.c_bool, SDL_POINTER[SDL_Process], ctypes.c_bool, SDL_POINTER[ctypes.c_int])
SDL_FUNC("SDL_DestroyProcess", None, SDL_POINTER[SDL_Process])