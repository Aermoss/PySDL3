...
SDL_FUNC("SDL_AddGamepadMappingsFromIO", ctypes.c_int, SDL_POINTER[SDL_IOStream], ctypes.c_bool)
SDL_FUNC("SDL_AddGamepadMappingsFromFile", ctypes.c_int, ctypes.c_char_p)
SDL_FUNC("SDL_ReloadGamepadMappings", ctypes.c_bool)
SDL_FUNC("SDL_GetGamepadMappings", SDL_POINTER[ctypes.c_char_p], SDL_POINTER[ctypes.c_int])
SDL_FUNC("SDL_GetGamepadMappingForGUID", ctypes.c_char_p, SDL_GUID)
SDL_FUNC("SDL_GetGamepadMapping", ctypes.c_char_p, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_SetGamepadMapping", ctypes.c_bool, SDL_JoystickID, ctypes.c_char_p)
SDL_FUNC("SDL_HasGamepad", ctypes.c_bool)
SDL_FUNC("SDL_GetGamepads", SDL_POINTER[SDL_JoystickID], SDL_POINTER[ctypes.c_int])
...
SDL_FUNC("SDL_OpenGamepad", SDL_POINTER[SDL_Gamepad], SDL_JoystickID)
SDL_FUNC("SDL_GetGamepadFromID", SDL_POINTER[SDL_Gamepad], SDL_JoystickID)
SDL_FUNC("SDL_GetGamepadFromPlayerIndex", SDL_POINTER[SDL_Gamepad], ctypes.c_int)
SDL_FUNC("SDL_GetGamepadProperties", SDL_PropertiesID, SDL_POINTER[SDL_Gamepad])
...
SDL_FUNC("SDL_GetGamepadID", SDL_JoystickID, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_GetGamepadName", ctypes.c_char_p, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_GetGamepadPath", ctypes.c_char_p, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_GetGamepadType", SDL_GamepadType, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_GetRealGamepadType", SDL_GamepadType, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_GetGamepadPlayerIndex", ctypes.c_int, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_SetGamepadPlayerIndex", ctypes.c_bool, SDL_POINTER[SDL_Gamepad], ctypes.c_int)
SDL_FUNC("SDL_GetGamepadVendor", ctypes.c_uint16, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_GetGamepadProduct", ctypes.c_uint16, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_GetGamepadProductVersion", ctypes.c_uint16, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_GetGamepadFirmwareVersion", ctypes.c_uint16, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_GetGamepadSerial", ctypes.c_char_p, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_GetGamepadSteamHandle", ctypes.c_uint64, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_GetGamepadConnectionState", SDL_JoystickConnectionState, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_GetGamepadPowerInfo", SDL_PowerState, SDL_POINTER[SDL_Gamepad], SDL_POINTER[ctypes.c_int])
SDL_FUNC("SDL_GamepadConnected", ctypes.c_bool, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_GetGamepadJoystick", SDL_POINTER[SDL_Joystick], SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_SetGamepadEventsEnabled", None, ctypes.c_bool)
SDL_FUNC("SDL_GamepadEventsEnabled", ctypes.c_bool)
SDL_FUNC("SDL_GetGamepadBindings", SDL_POINTER[SDL_POINTER[SDL_GamepadBinding]], SDL_POINTER[SDL_Gamepad], SDL_POINTER[ctypes.c_int])
...
SDL_FUNC("SDL_GamepadHasAxis", ctypes.c_bool, SDL_POINTER[SDL_Gamepad], SDL_GamepadAxis)
SDL_FUNC("SDL_GetGamepadAxis", ctypes.c_int16, SDL_POINTER[SDL_Gamepad], SDL_GamepadAxis)
...
SDL_FUNC("SDL_GamepadHasButton", ctypes.c_bool, SDL_POINTER[SDL_Gamepad], SDL_GamepadButton)
SDL_FUNC("SDL_GetGamepadButton", ctypes.c_bool, SDL_POINTER[SDL_Gamepad], SDL_GamepadButton)
SDL_FUNC("SDL_GetGamepadButtonLabelForType", SDL_GamepadButtonLabel, SDL_GamepadType, SDL_GamepadButton)
SDL_FUNC("SDL_GetGamepadButtonLabel", SDL_GamepadButtonLabel, SDL_POINTER[SDL_Gamepad], SDL_GamepadButton)
SDL_FUNC("SDL_GetNumGamepadTouchpads", ctypes.c_int, SDL_POINTER[SDL_Gamepad])
SDL_FUNC("SDL_GetNumGamepadTouchpadFingers", ctypes.c_int, SDL_POINTER[SDL_Gamepad], ctypes.c_int)
SDL_FUNC("SDL_GetGamepadTouchpadFinger", ctypes.c_bool, SDL_POINTER[SDL_Gamepad], ctypes.c_int, ctypes.c_int, SDL_POINTER[ctypes.c_uint8], SDL_POINTER[ctypes.c_float], SDL_POINTER[ctypes.c_float], SDL_POINTER[ctypes.c_float])
SDL_FUNC("SDL_GamepadHasSensor", ctypes.c_bool, SDL_POINTER[SDL_Gamepad], SDL_SensorType)
SDL_FUNC("SDL_SetGamepadSensorEnabled", ctypes.c_bool, SDL_POINTER[SDL_Gamepad], SDL_SensorType, ctypes.c_bool)
SDL_FUNC("SDL_GamepadSensorEnabled", ctypes.c_bool, SDL_POINTER[SDL_Gamepad], SDL_SensorType)
SDL_FUNC("SDL_GetGamepadSensorDataRate", ctypes.c_float, SDL_POINTER[SDL_Gamepad], SDL_SensorType)
SDL_FUNC("SDL_GetGamepadSensorData", ctypes.c_bool, SDL_POINTER[SDL_Gamepad], SDL_SensorType, SDL_POINTER[ctypes.c_float], ctypes.c_int)
SDL_FUNC("SDL_RumbleGamepad", ctypes.c_bool, SDL_POINTER[SDL_Gamepad], ctypes.c_uint16, ctypes.c_uint16, ctypes.c_uint32)
SDL_FUNC("SDL_RumbleGamepadTriggers", ctypes.c_bool, SDL_POINTER[SDL_Gamepad], ctypes.c_uint16, ctypes.c_uint16, ctypes.c_uint32)
SDL_FUNC("SDL_SetGamepadLED", ctypes.c_bool, SDL_POINTER[SDL_Gamepad], ctypes.c_uint8, ctypes.c_uint8, ctypes.c_uint8)
SDL_FUNC("SDL_SendGamepadEffect", ctypes.c_bool, SDL_POINTER[SDL_Gamepad], ctypes.c_void_p, ctypes.c_int)
SDL_FUNC("SDL_CloseGamepad", None, SDL_POINTER[SDL_Gamepad])

SDL_FUNC("SDL_GetGamepadAppleSFSymbolsNameForButton", ctypes.c_char_p, SDL_POINTER[SDL_Gamepad], SDL_GamepadButton)
SDL_FUNC("SDL_GetGamepadAppleSFSymbolsNameForAxis", ctypes.c_char_p, SDL_POINTER[SDL_Gamepad], SDL_GamepadAxis)